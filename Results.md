...
## Granite-8b  ✅ 
![alt text](<prefix-cache-nvidia/precise-prefix-granite/benchmark-results/comparison_rates_3_to_22 copy.png>)

**Highlight :  llm-d improves TTFT by upto 16x compared to K8s, and throughput (Output tok/s) by 25-36%**

## Sarvam-30b ✅ 

![alt text](prefix-cache-nvidia/precise-prefix-sarvam-30b/benchmark/comparison_rates_3_to_50.png)
...
![alt text](prefix-cache-amd/precise-prefix-granite-amd-fresh/benchmark/comparison_amd_fresh.png)

**llm-d delivers up to 21× better TTFT and +79% throughput vs plain k8s round-robin on this AMD-only granite deployment**
## Sarvam-30b

![alt text](prefix-cache-amd/precise-prefix-sarvam-30b-amd/benchmark/comparison_rates_5_to_200_amd.png)
...
## Granite-8b ✅ 
![alt text](prefix-cache-gaudi/granite-8b/benchmark/comparison_gaudi_only.png)
...
![alt text](prefix-cache-nvidia-amd/benchmark/comparison_mixed_pool_1.png)
...
![alt text](prefix-cache-nvidia-amd/precise-prefix-sarvam-30b-mixed/benchmark/comparison_rates_5_to_200_mixed.png)
...
## Granite-8b ✅
![alt text](prefix-cache-3vendor/mixed-3vendor-granite/benchmark/comparison_3vendor.png)
...
![alt text](prefix-cache-3vendor/benchmark/comparison_3vendor_pool.png)

# NVIDIA - 4 GPUs (PD Disaggregation)
## Sarvam-30b 

![Trying with llm-d 0.7](pd-disaggregation/precise-pd-sarvam30b/benchmark/comparison_2p2d_highlights.png)
