...
LLMD = next(BASE.glob("results-llmd-scaled/**/inference-perf_*_llmd-amd-granite-scaled"))
K8S = next(BASE.glob("results-k8s-scaled/**/inference-perf_*_k8s-amd-granite-scaled"))
...
plt.tight_layout()
out = BASE / "comparison_amd_only.png"
